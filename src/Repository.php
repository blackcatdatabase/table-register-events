...
use BlackCat\Database\Packages\RegisterEvents\Repository\RegisterEventRepositoryInterface;
use BlackCat\Database\Packages\RegisterEvents\Repository\RegisterEventRepository as GeneratedRepository;
...
{
  private RegisterEventRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof RegisterEventRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected RegisterEventRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\RegisterEvents\Dto\RegisterEventDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\RegisterEvents\Dto\RegisterEventDto|null { return $this->repo->getById($id, $asDto); }
