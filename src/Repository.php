...
{
    private RegisterEventRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new RegisterEventRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\RegisterEvents\Dto\RegisterEventDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\RegisterEvents\Dto\RegisterEventDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\RegisterEvents\Dto\RegisterEventDto|null
    {
