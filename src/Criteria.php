...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'user_id', 'type', 'ip_hash', 'ip_hash_key_version', 'user_agent', 'occurred_at', 'meta' ];
    }

    /** Columns used for full-text LIKE/ILIKE searches. */
    protected function searchable(): array
    {
        return [ 'type', 'ip_hash_key_version', 'user_agent' ];
    }
...
protected function sortable(): array
{
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\RegisterEvents\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\RegisterEvents\Definitions::softDeleteColumn();
