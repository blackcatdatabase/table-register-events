 ...
 * - whitelist filtrů: [ 'id', 'user_id', 'type', 'ip_hash', 'ip_hash_key_version', 'user_agent', 'occurred_at', 'meta' ]
 * - whitelist pro LIKE hledání: [ 'type', 'ip_hash_key_version', 'user_agent' ]
 */
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        // filtry (rovnosti / IN)
        $allowed = array_fill_keys([ 'id', 'user_id', 'type', 'ip_hash', 'ip_hash_key_version', 'user_agent', 'occurred_at', 'meta' ], true);
        ...
        if ($this->search !== null) {
            $searchCols = [ 'type', 'ip_hash_key_version', 'user_agent' ];
            $likeParts = [];
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'user_id', 'type', 'ip_hash', 'ip_hash_key_version', 'user_agent', 'occurred_at', 'meta' ], true);
            $parts = [];
