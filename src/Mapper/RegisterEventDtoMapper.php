...
namespace BlackCat\Database\Packages\RegisterEvents\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO RegisterEventDto:
 ...
 */
final class RegisterEventDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'user_id' => 'userId', 'ip_hash' => 'ipHash', 'ip_hash_key_version' => 'ipHashKeyVersion', 'user_agent' => 'userAgent', 'occurred_at' => 'occurredAt' ];
     ...
     */
    public static function fromRow(array $row): RegisterEventDto
    {
        /** @var RegisterEventDto */
        return DtoHydrator::fromRow(
            RegisterEventDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?RegisterEventDto
    {
     ...
     *
     * @param RegisterEventDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(RegisterEventDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(RegisterEventDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(RegisterEventDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,RegisterEventDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,RegisterEventDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(RegisterEventDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,RegisterEventDto>
     */
