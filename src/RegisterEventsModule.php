...
final class RegisterEventsModule implements ModuleInterface
{
    public function name(): string { return 'table-register_events'; }
    public function table(): string { return 'register_events'; }
    ...
    public static function contractView(): string { return 'vw_register_events'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_reg_ip', 'idx_reg_time', 'idx_reg_type_time', 'idx_reg_user' ];
        if ($d->isMysql()) {
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_reg_ip', 'idx_reg_time', 'idx_reg_type_time', 'idx_reg_user' ],
            'foreignKeys' => [ 'fk_register_user' ],
        ];
    }
}
