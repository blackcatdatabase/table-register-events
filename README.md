...
- Pkg folder: [packages\register-events](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\register-events)
...
graph LR
  ...
  register_events["register_events"]:::center
  register_events -->|FK| users["users"]:::link
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package register-events -Apply
