...
| Pkg folder | [packages/register-events](https://github.com/blackcatacademy/blackcat-database/blob/main/packages/register-events) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package register-events -Apply
